    ...
    <div className='container mt-3'>
      ...
      <div className="collapse" id="collapseProyect">
        <div className="card card-body">
          ...
          <p>
            <a href='https://dlmp3online.com/home' target='_blank'><strong>DLMP3</strong></a> es una página web con la que puedes descargar musica y videos desde YouTube, 
          ...
          <p style={{textAlign: 'center'}}><cite>(Resultado futuro), <a href='https://dlmp3online.com/home' target='_blank'><strong>Resultado actual</strong></a> (puede demorar unos segundos al inicio).</cite></p>
        </div>
      </div>
