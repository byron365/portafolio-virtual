    ...
    <div className='container mt-3'>
      ...
      <div className="collapse" id="collapseProyect">
        <div className="card card-body">
          ...
          <p>
            <a href='https://dlmp3-proyect.herokuapp.com/' target='_blank'><strong>DLMP3</strong></a> es una página web con la que puedes descargar musica y videos desde YouTube, 
          ...
          <ul>
              ...
              <li>Bootstrap: Para los estilos css, aunque algunos fueron adaptados para la página.</li>
          ...
          <p style={{textAlign: 'center'}}><cite>(Resultado futuro), <a href='https://dlmp3-proyect.herokuapp.com/' target='_blank'><strong>Resultado actual</strong></a> (puede demorar unos segundos al inicio).</cite></p>
        </div>
      </div>

      <button className="category-item transition item-proyect" type="button" data-bs-toggle="collapse" data-bs-target="#collapseProyect2" aria-expanded="false" aria-controls="collapseProyect">
        MyNotes
      </button>
      <hr/>
      
      <div className="collapse" id="collapseProyect2">
        <div className="card card-body">
          <h4>Descripción:</h4><br/>
          <p>
            <a href='https://mynotes-app2022.herokuapp.com/' target='_blank'><strong>MyNotes</strong></a> Ingresa al link, puedes agregar una nota o un contacto únicamente haciendo clic en el botón agregar
           luego seleccionando la opción que desees.
            <br/><br/>
            La página está diseñada con el motor de plantillas Handlebars el cual 
            se renderiza desde un servidor de node creado con el framework express, este 
            recibe las rutas para procesar las notas y contactos para luego almacenarlos en la base de datos
            de PostgreSQL.
          </p>

          <img src='https://res.cloudinary.com/dfxizywkv/image/upload/v1667403735/img/mynotes_d7az8s.png'/>
          <br/><br/>
          <h4>Características e implementaciones:</h4><br/>
          <p>
            Se puede agregar, editar y eliminar notas y contactos.
            la pagina está implementada por las siguientes tecnologías:
            <br/>
          </p>
          <ul>
              ...
              <li>Handlebars: Motor de plantillas utilizado para la creación de las plantillas HTML.</li>
              <li>Bootstrap: Para los estilos css, aunque algunos fueron adaptados para la página.</li>
              <li>Pg: Modulo para la conexión con la base de datos de PostgreSQL.</li>
              <li>PostgreSQL: Base de datos relacional, en la cual se almacenan las notas y contactos.</li>
              <li>Git: Para el manejo de versiones.</li>
              <li>Heroku: Plataforma en la cual se desplegó la aplicación y la base de datos. </li>
          </ul>
        </div>
      </div>
